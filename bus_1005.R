...
library(readxl)
bus_data <- read_excel("D:/BILAL/bus data_990.1000.1001.1002.1004.1005/노선별 승하차 자료(1002 1001).xlsx", sheet = "1005")
...
c1005<- as.data.frame(union(c1,c2))
...
origin_stops<- c("충남대학교", "시청")
final_stops<- c("새롬중학교(새뜸마을1단지)","새뜸마을4단지(가온마을1단지)")
...
#bus that starts
write.csv(final, "D:/BILAL/bus data_990.1000.1001.1002.1004.1005/output1005_imp.csv")
