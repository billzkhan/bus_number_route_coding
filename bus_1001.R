...
bus_data <- read_excel("D:/BILAL/bus data_990.1000.1001.1002.1004.1005/노선별 승하차 자료(1002 1001).xlsx", sheet = "1001")
...
c1001<- as.data.frame(union(c1,c2))
...
final_stops<- c("으능정이거리","중앙로역6번출구","복합터미널","한남대학교")
origin_stops<- c("소담동","세종시청.교육청.시의회","한국개발연구원(KDI)","도담동",
                 "반곡동(수루배마을)","보람동.대평동","새롬동.나성동")
...
#bus that starts
write.csv(final, "D:/BILAL/bus data_990.1000.1001.1002.1004.1005/output1001_imp.csv")
