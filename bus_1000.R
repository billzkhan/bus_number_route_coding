...
bus_data <- read_excel("D:/BILAL/bus data_990.1000.1001.1002.1004.1005/노선별 승하차 자료(1002 1001).xlsx", sheet = "1000")
...
c1000<- as.data.frame(union(c1,c2))
...
origin_stops<- c("시청","정부청사","유성온천","노은","한밭대학교", "탄방","용문","서대전네거리")
final_stops<- c("대평동커뮤니티센터","가재마을5,8단지","금남면사무소","가재마을7단지","종촌고등학교",
                "가락마을7,8단지")
...
#bus that starts
write.csv(final, "D:/BILAL/bus data_990.1000.1001.1002.1004.1005/output1000_imp.csv")
