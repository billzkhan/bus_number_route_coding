...
bus_data <- read_excel("D:/BILAL/bus data_990.1000.1001.1002.1004.1005/노선별 승하차 자료(1002 1001).xlsx", sheet = "1004")
...
c1004<- as.data.frame(union(c1,c2))
...
origin_stops<- c("시청", "유성온천", "정부청사", "충남대학교", "노은")
final_stops<- c("새뜸마을5,8단지","새롬동커뮤니티센터","한솔중학교(첫마을7단지)",
                "첫마을3단지","가온마을4,7단지","첫마을4단지","첫마을6단지", "범지기마을8,12단지")
...
empty<- new_6[which(is.na(new_6$lat.1)),]
...
#bus that starts
write.csv(final, "D:/BILAL/bus data_990.1000.1001.1002.1004.1005/output1004_imp.csv")
